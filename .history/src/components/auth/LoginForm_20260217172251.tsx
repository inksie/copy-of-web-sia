    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#F8FAF5' }}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-12">
          <div className="inline-block p-4 rounded-full shadow-lg" style={{ backgroundColor: '#3E5F44', boxShadow: '0 10px 25px -5px rgba(62, 95, 68, 0.3)' }}>
            <h1 className="text-3xl font-bold text-white">SIA</h1>
          </div>
        </div>
