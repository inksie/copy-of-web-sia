...
export function Sidebar() {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="p-3 border-b border-[#2F4A35]">
          {!collapsed && (
            <div className="overflow-hidden flex items-center gap-2">
              <ChevronLeft className="w-4 h-4 text-white/60 cursor-pointer hover:text-white transition-colors" />
              <div>
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.path}
                className={cn(
  "sidebar-item text-white/70 hover:text-white hover:bg-[#446A50] transition-colors",
  isActive && "bg-[#446A50] text-white border-l-4 border-white/30"
)}
              >
        ...
        <div className="p-2 border-t border-[#2F4A35]">
          ...
          <button
            ...
            className="sidebar-item w-full text-left text-white/80 hover:text-white hover:bg-[#2F4A35] transition-colors"
          >
