        ...
        <div className="p-2 border-t border-[#2F4A35]">
          {!collapsed && user && (
            <div className="px-2 py-1.5 mb-1 flex items-center gap-2">
              <div className="w-6 h-6 bg-[#F5E6C8] rounded-md flex items-center justify-center text-[#3E5F44] font-bold text-xs">
                {getEmailInitial()}
              </div>
          ...
          <div className="flex justify-center">
            <button
              ...
              className="sidebar-item w-auto text-left text-white/80 hover:text-white hover:bg-[#2F4A35] transition-colors"
            >
